...
module.exports = function(app,mongo) {
    ...
    app.get('/seed/flights', function (req, res) {
      ...
      for (var i = 0; i < routes.length; i++) {
        var route = routes[i];
        seedFlights(route, route.origin, route.destination,"outgoing");
      }

      // insert returning flights
      for (var i = 0; i < routes.length; i++) {
        var route = routes[i];
        seedFlights(route, route.destination, route.origin,"returning");
      }

    });


    function seedFlights(flight, _origin, _destination,key) {
      ...
      for (var i = 0; i < 44; i++) {
        ...
        doc = 
        {
          ...
          //check the math of multiplying key with departureTime
        ...
        //setting the departure date time accordingly
